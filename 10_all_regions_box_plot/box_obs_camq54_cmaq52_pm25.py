...
plt.text(0.5,38,'Airnow',color='gray',fontsize=30,fontweight="bold")
plt.text(0.5,35,'CMAQ v5.4',color='blue',fontsize=30,fontweight="bold")
plt.text(0.5,32,'CMAQ v5.2',color='red',fontsize=30,fontweight="bold")
