...
0) initialization
'''
variable_name_obs = 'NO'  #CHANGE HERE 1
variable_name_cmaq52 = 'no_ave'  #CHANGE HERE 2
variable_name_cmaq54 = 'no_ave'   #CHANGE HERE 3

save_name = 'NO'                 #CHANGE HERE 4
'''
1) open dataset
'''
...
plt.text(0.5,4.5,'Airnow',color='gray',fontsize=30,fontweight="bold")
plt.text(0.5,4.2,'CMAQ v5.4',color='blue',fontsize=30,fontweight="bold")
plt.text(0.5,3.9,'CMAQ v5.2',color='red',fontsize=30,fontweight="bold")

plt.ylim(0,5)  #CHANGE HERE 5
