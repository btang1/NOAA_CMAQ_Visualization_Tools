...
pattern = 'Surface_Map_no2.nc'                                                  #change chemical species1
filename = dirw+ pattern
f = Dataset(filename,'r')

lat_wrf  = f.variables['lat'][:]
lon_wrf  = f.variables['lon'][:]
no2_wrf = f.variables['no2'][:]                                                 #change chemical species2
...
NO2_CMAQ54 = no2_compare   #change chemical species4
...
NO2_CMAQ52 = no2_compare   #change chemical species4
