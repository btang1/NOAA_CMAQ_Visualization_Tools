...
pattern = 'Surface_Map_vwnd.nc'                                                  #change chemical species1
filename = dirw+ pattern
f = Dataset(filename,'r')

lat_wrf  = f.variables['lat'][:]
lon_wrf  = f.variables['lon'][:]
no2_wrf = f.variables['vwnd'][:]                                                 #change chemical species2
...
VWND_CMAQ54 = no2_compare   #change chemical species4
...
VWND_CMAQ52 = no2_compare   #change chemical species4
