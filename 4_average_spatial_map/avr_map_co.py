...
m.pcolormesh(Lon_0, Lat_0, data_avr,latlon=True, vmin = 0, vmax = 500, cmap = 'jet') 
...
m.drawcountries()
m.drawstates()
plt.title('Averages for CO from '+ str(Time_CMAQ[0])+'\nto '+ str(Time_CMAQ[-1]),fontsize=30)
plt.savefig('avr_co',dpi = 100)
