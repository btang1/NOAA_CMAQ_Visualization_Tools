...
0) initialization
'''
variable_name_obs = 'CO'  #CHANGE HERE 1
variable_name_cmaq52 = 'co'  #CHANGE HERE 2
variable_name_cmaq54 = 'co'   #CHANGE HERE 3

save_name = 'CO'                 #CHANGE HERE 4
'''
1) open dataset
'''
...
plt.text(0.5,700,'Airnow',color='gray',fontsize=30,fontweight="bold")
plt.text(0.5,650,'CMAQ v5.4',color='blue',fontsize=30,fontweight="bold")
plt.text(0.5,600,'CMAQ v5.2',color='red',fontsize=30,fontweight="bold")

plt.ylim(50,750)  #CHANGE HERE 5
