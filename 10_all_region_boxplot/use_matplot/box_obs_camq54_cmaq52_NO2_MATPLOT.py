...
0) initialization
'''
variable_name_obs = 'NO2'  #CHANGE HERE 1
variable_name_cmaq52 = 'no2_ave'  #CHANGE HERE 2
variable_name_cmaq54 = 'no2_ave'   #CHANGE HERE 3

save_name = 'NO2'                 #CHANGE HERE 4
'''
1) open dataset
'''
...
plt.text(0.5,18,'Airnow',color='gray',fontsize=30,fontweight="bold")
plt.text(0.5,17,'CMAQ v5.4',color='blue',fontsize=30,fontweight="bold")
plt.text(0.5,16,'CMAQ v5.2',color='red',fontsize=30,fontweight="bold")

plt.ylim(0,20)  #CHANGE HERE 5
