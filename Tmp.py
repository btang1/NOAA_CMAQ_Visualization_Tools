...
pattern = 'Surface_Map_temp.nc'                                                  #change chemical species1
filename = dirw+ pattern
f = Dataset(filename,'r')

lat_wrf  = f.variables['lat'][:]
lon_wrf  = f.variables['lon'][:]
no2_wrf = f.variables['temp'][:]                                                 #change chemical species2
...
TEMP_CMAQ54 = no2_compare   #change chemical species4




'''
3)import CMAQ 5.4 data
'''
...
TEMP_CMAQ52 = no2_compare   #change chemical species4
