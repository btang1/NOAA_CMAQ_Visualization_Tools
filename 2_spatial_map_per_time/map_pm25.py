...
for i in range(len(data_0)):
    ...
    m.pcolormesh(Lon_0, Lat_0, data_1,latlon=True, vmin=0, vmax=1E-3, cmap = 'jet') 
    
    cb =plt.colorbar(orientation="horizontal")
    cb.set_label('$PM_{2.5}$ (\u03bcg/$m^3$)',fontsize = 30)                                                            #change units
    ...
    plt.savefig('pm25_'+str(i),dpi = 100)
