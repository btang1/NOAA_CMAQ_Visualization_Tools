...
data_0 = f.variables['temp'][:]                                         #change chemical species
...
for i in range(len(data_0)):
    ...
    m.pcolormesh(Lon_0, Lat_0, data_1,latlon=True, vmin=270, vmax= 310, cmap = 'jet') 
    
    cb =plt.colorbar(orientation="horizontal")
    cb.set_label('T (K)',fontsize = 30)                                                            #change units
    ...
    plt.savefig('temp_'+str(i),dpi = 100)
