...
for i in range(len(data_0)):
    ...
    m.pcolormesh(Lon_0, Lat_0, data_1,latlon=True, vmin=0, vmax= 1, cmap = 'jet') 
    
    cb =plt.colorbar(orientation="horizontal")
    cb.set_label('$NO$ (ppbv)',fontsize = 30)                                                            #change units
