...
pattern = 'Surface_Map_ps.nc'                                                  #change chemical species1
filename = dirw+ pattern
f = Dataset(filename,'r')

lat_wrf  = f.variables['lat'][:]
lon_wrf  = f.variables['lon'][:]
no2_wrf = f.variables['ps'][:]                                                 #change chemical species2
...
PS_CMAQ54 = no2_compare   #change chemical species4
...
PS_CMAQ52 = no2_compare   #change chemical species4
