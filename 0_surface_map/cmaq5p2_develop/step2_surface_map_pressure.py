...
ft = Dataset(('Surface_Map_'+"ps.nc"),'w',format = 'NETCDF4')                # change chemicals name here
...
vmrno2 = ft.createVariable('ps','f4',('ntime','nlat','nlon'))                # change chemicals name here
vmrno2.units ='pa'                                                         # change unit here
vmrno2.description =''
...
for i in range(len(filelist)):
    ...
    vmrno2_w= f.variables['ps'][0,:]                                       #change chemical variables here
