...
ft = Dataset(('Surface_Map_'+"uwnd.nc"),'w',format = 'NETCDF4')                # change chemicals name here
...
vmrno2 = ft.createVariable('uwnd','f4',('ntime','nlat','nlon'))                # change chemicals name here
vmrno2.units ='m/s'                                                         # change unit here
vmrno2.description =''
...
for i in range(len(filelist)):
    ...
    vmrno2_w= f.variables['uwnd'][0,:]                                       #change chemical variables here
