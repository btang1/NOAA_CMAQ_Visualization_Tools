...
ft = Dataset(('Surface_Map_'+"no.nc"),'w',format = 'NETCDF4')                # change chemicals name here
...
vmrno2 = ft.createVariable('no','f4',('ntime','nlat','nlon'))                # change chemicals name here
...
for i in range(len(filelist)):
    ...
    vmrno2_w= f.variables['no'][0,:]                                       #change chemical variables here
