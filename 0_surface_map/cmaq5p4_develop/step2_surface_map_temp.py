...
ft = Dataset(('Surface_Map_'+"temp.nc"),'w',format = 'NETCDF4')                # change chemicals name here
...
vmrno2 = ft.createVariable('temp','f4',('ntime','nlat','nlon'))                # change chemicals name here
vmrno2.units ='K'                                                         # change unit here
vmrno2.description =''
...
for i in range(len(filelist)):
    ...
    vmrno2_w= f.variables['tmp'][0,:]                                       #change chemical variables here
