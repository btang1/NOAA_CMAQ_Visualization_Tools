...
ft = Dataset(('Surface_Map_'+"vwnd.nc"),'w',format = 'NETCDF4')                # change chemicals name here
...
vmrno2 = ft.createVariable('vwnd','f4',('ntime','nlat','nlon'))                # change chemicals name here
...
for i in range(len(filelist)):
    ...
    vmrno2_w= f.variables['vwnd'][0,:]                                       #change chemical variables here
